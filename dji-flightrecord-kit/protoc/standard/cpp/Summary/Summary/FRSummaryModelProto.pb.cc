...
static ::_pb::Metadata file_level_metadata_Summary_2fFRSummaryModelProto_2eproto[5];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_Summary_2fFRSummaryModelProto_2eproto[1];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_Summary_2fFRSummaryModelProto_2eproto = nullptr;

const uint32_t TableStruct_Summary_2fFRSummaryModelProto_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_Summary_2fFRSummaryModelProto_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "\006proto3"
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_Summary_2fFRSummaryModelProto_2eproto_deps[1] = {
  &::descriptor_table_Common_2fFRCommonModelProto_2eproto,
};
static ::_pbi::once_flag descriptor_table_Summary_2fFRSummaryModelProto_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_Summary_2fFRSummaryModelProto_2eproto = {
    false, false, 1447, descriptor_table_protodef_Summary_2fFRSummaryModelProto_2eproto,
    "Summary/FRSummaryModelProto.proto",
    &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_once, descriptor_table_Summary_2fFRSummaryModelProto_2eproto_deps, 1, 5,
    schemas, file_default_instances, TableStruct_Summary_2fFRSummaryModelProto_2eproto::offsets,
    file_level_metadata_Summary_2fFRSummaryModelProto_2eproto, file_level_enum_descriptors_Summary_2fFRSummaryModelProto_2eproto,
    file_level_service_descriptors_Summary_2fFRSummaryModelProto_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_Summary_2fFRSummaryModelProto_2eproto_getter() {
  return &descriptor_table_Summary_2fFRSummaryModelProto_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_Summary_2fFRSummaryModelProto_2eproto(&descriptor_table_Summary_2fFRSummaryModelProto_2eproto);
namespace DJIFRProto {
namespace Standard {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* SummaryInformation_Platform_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_Summary_2fFRSummaryModelProto_2eproto);
  return file_level_enum_descriptors_Summary_2fFRSummaryModelProto_2eproto[0];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ComponentInformation::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_getter, &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_once,
      file_level_metadata_Summary_2fFRSummaryModelProto_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata SummaryInformation_BatteriesInformationEntry_DoNotUse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_getter, &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_once,
      file_level_metadata_Summary_2fFRSummaryModelProto_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata SummaryInformation_CamerasInformationEntry_DoNotUse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_getter, &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_once,
      file_level_metadata_Summary_2fFRSummaryModelProto_2eproto[2]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata SummaryInformation_GimbalsInformationEntry_DoNotUse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_getter, &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_once,
      file_level_metadata_Summary_2fFRSummaryModelProto_2eproto[3]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata SummaryInformation::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_getter, &descriptor_table_Summary_2fFRSummaryModelProto_2eproto_once,
      file_level_metadata_Summary_2fFRSummaryModelProto_2eproto[4]);
}
