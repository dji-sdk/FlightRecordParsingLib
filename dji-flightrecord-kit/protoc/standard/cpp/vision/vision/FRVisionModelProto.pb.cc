...
static ::_pb::Metadata file_level_metadata_vision_2fFRVisionModelProto_2eproto[6];
static const ::_pb::EnumDescriptor* file_level_enum_descriptors_vision_2fFRVisionModelProto_2eproto[3];
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_vision_2fFRVisionModelProto_2eproto = nullptr;

const uint32_t TableStruct_vision_2fFRVisionModelProto_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_vision_2fFRVisionModelProto_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "to3"
  ;
static ::_pbi::once_flag descriptor_table_vision_2fFRVisionModelProto_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_vision_2fFRVisionModelProto_2eproto = {
    false, false, 1283, descriptor_table_protodef_vision_2fFRVisionModelProto_2eproto,
    "vision/FRVisionModelProto.proto",
    &descriptor_table_vision_2fFRVisionModelProto_2eproto_once, nullptr, 0, 6,
    schemas, file_default_instances, TableStruct_vision_2fFRVisionModelProto_2eproto::offsets,
    file_level_metadata_vision_2fFRVisionModelProto_2eproto, file_level_enum_descriptors_vision_2fFRVisionModelProto_2eproto,
    file_level_service_descriptors_vision_2fFRVisionModelProto_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_vision_2fFRVisionModelProto_2eproto_getter() {
  return &descriptor_table_vision_2fFRVisionModelProto_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_vision_2fFRVisionModelProto_2eproto(&descriptor_table_vision_2fFRVisionModelProto_2eproto);
namespace DJIFRProto {
namespace Standard {
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Vision_ObstacleDetectionSectorWarning_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_vision_2fFRVisionModelProto_2eproto);
  return file_level_enum_descriptors_vision_2fFRVisionModelProto_2eproto[0];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Vision_VisionSensorPosition_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_vision_2fFRVisionModelProto_2eproto);
  return file_level_enum_descriptors_vision_2fFRVisionModelProto_2eproto[1];
}
...
const ::PROTOBUF_NAMESPACE_ID::EnumDescriptor* Vision_VisionSystemWarning_descriptor() {
  ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&descriptor_table_vision_2fFRVisionModelProto_2eproto);
  return file_level_enum_descriptors_vision_2fFRVisionModelProto_2eproto[2];
}
...
::PROTOBUF_NAMESPACE_ID::Metadata Vision::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_vision_2fFRVisionModelProto_2eproto_getter, &descriptor_table_vision_2fFRVisionModelProto_2eproto_once,
      file_level_metadata_vision_2fFRVisionModelProto_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata VisionControlState::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_vision_2fFRVisionModelProto_2eproto_getter, &descriptor_table_vision_2fFRVisionModelProto_2eproto_once,
      file_level_metadata_vision_2fFRVisionModelProto_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata ObstacleDetectionSector::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_vision_2fFRVisionModelProto_2eproto_getter, &descriptor_table_vision_2fFRVisionModelProto_2eproto_once,
      file_level_metadata_vision_2fFRVisionModelProto_2eproto[2]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata VisionDetectionState::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_vision_2fFRVisionModelProto_2eproto_getter, &descriptor_table_vision_2fFRVisionModelProto_2eproto_once,
      file_level_metadata_vision_2fFRVisionModelProto_2eproto[3]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata VisionState_DetectionStateMapEntry_DoNotUse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_vision_2fFRVisionModelProto_2eproto_getter, &descriptor_table_vision_2fFRVisionModelProto_2eproto_once,
      file_level_metadata_vision_2fFRVisionModelProto_2eproto[4]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata VisionState::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_vision_2fFRVisionModelProto_2eproto_getter, &descriptor_table_vision_2fFRVisionModelProto_2eproto_once,
      file_level_metadata_vision_2fFRVisionModelProto_2eproto[5]);
}
