...
static ::_pb::Metadata file_level_metadata_FrameTime_2fFRFrameTimeModelProto_2eproto[5];
static constexpr ::_pb::EnumDescriptor const** file_level_enum_descriptors_FrameTime_2fFRFrameTimeModelProto_2eproto = nullptr;
static constexpr ::_pb::ServiceDescriptor const** file_level_service_descriptors_FrameTime_2fFRFrameTimeModelProto_2eproto = nullptr;

const uint32_t TableStruct_FrameTime_2fFRFrameTimeModelProto_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
...
const char descriptor_table_protodef_FrameTime_2fFRFrameTimeModelProto_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::_pbi::DescriptorTable* const descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_deps[10] = {
  &::descriptor_table_AirLink_2fAirLink_2eproto,
  &::descriptor_table_Battery_2fFRBatteryStateProto_2eproto,
  &::descriptor_table_Camera_2fFRCameraStateProto_2eproto,
  &::descriptor_table_FlightController_2fFRFlightControllerModelProto_2eproto,
  &::descriptor_table_GOBusinessData_2fGOBusinessData_2eproto,
  &::descriptor_table_Gimbal_2fFRGimbalModelProto_2eproto,
  &::descriptor_table_MobileDeviceState_2fMobileDeviceState_2eproto,
  &::descriptor_table_MobileRC_2fFRMobileRCModelProto_2eproto,
  &::descriptor_table_RC_2fFRRCModelProto_2eproto,
  &::descriptor_table_vision_2fFRVisionModelProto_2eproto,
};
static ::_pbi::once_flag descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_once;
const ::_pbi::DescriptorTable descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto = {
    false, false, 1661, descriptor_table_protodef_FrameTime_2fFRFrameTimeModelProto_2eproto,
    "FrameTime/FRFrameTimeModelProto.proto",
    &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_once, descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_deps, 10, 5,
    schemas, file_default_instances, TableStruct_FrameTime_2fFRFrameTimeModelProto_2eproto::offsets,
    file_level_metadata_FrameTime_2fFRFrameTimeModelProto_2eproto, file_level_enum_descriptors_FrameTime_2fFRFrameTimeModelProto_2eproto,
    file_level_service_descriptors_FrameTime_2fFRFrameTimeModelProto_2eproto,
};
PROTOBUF_ATTRIBUTE_WEAK const ::_pbi::DescriptorTable* descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_getter() {
  return &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto;
}

// Force running AddDescriptors() at dynamic initialization time.
PROTOBUF_ATTRIBUTE_INIT_PRIORITY2 static ::_pbi::AddDescriptorsRunner dynamic_init_dummy_FrameTime_2fFRFrameTimeModelProto_2eproto(&descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto);
namespace DJIFRProto {
namespace Standard {
...
::PROTOBUF_NAMESPACE_ID::Metadata FrameTimeState_GimbalsStateEntry_DoNotUse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_getter, &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_once,
      file_level_metadata_FrameTime_2fFRFrameTimeModelProto_2eproto[0]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata FrameTimeState_CamerasStateEntry_DoNotUse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_getter, &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_once,
      file_level_metadata_FrameTime_2fFRFrameTimeModelProto_2eproto[1]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata FrameTimeState_BatteriesStateEntry_DoNotUse::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_getter, &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_once,
      file_level_metadata_FrameTime_2fFRFrameTimeModelProto_2eproto[2]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata FrameTimeState::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_getter, &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_once,
      file_level_metadata_FrameTime_2fFRFrameTimeModelProto_2eproto[3]);
}
...
::PROTOBUF_NAMESPACE_ID::Metadata FrameTimeStates::GetMetadata() const {
  return ::_pbi::AssignDescriptors(
      &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_getter, &descriptor_table_FrameTime_2fFRFrameTimeModelProto_2eproto_once,
      file_level_metadata_FrameTime_2fFRFrameTimeModelProto_2eproto[4]);
}
